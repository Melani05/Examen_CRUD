...
public class ConexionSQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into tb_categorias values('1', 'Mouse', '1', '24/09/2022)')");
        db.execSQL("insert into tb_categorias values('2', 'Teclados', '1', '24/09/2022)')");
        db.execSQL("insert into tb_categorias values('3', 'USB', '1', '25/09/2022)')");
        db.execSQL("insert into tb_categorias values('4', 'Monitor', '1', '25/09/2022)')");
        db.execSQL("insert into tb_categorias values('5', 'CPU', '1', '25/09/2022)')");
    }
